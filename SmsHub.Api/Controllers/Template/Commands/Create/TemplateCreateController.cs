...
namespace SmsHub.Api.Controllers.Template.Commands.Create
{
    ...
    public class TemplateCreateController : ControllerBase
    {
        ...
        private readonly ICreateTemplateHandler _createCommandHandler;
        public TemplateCreateController(IUnitOfWork uow, ICreateTemplateHandler createCommandHandler)
        {
            _uow = uow;
