...
namespace SmsHub.Api.Controllers.V1.Sending.Commands.Update
{
    ...
    public class MessageStateCategoryUpdateController : BaseController
    {
        ...
        [InformativeLogFilter(LogLevelEnum.InternalOperation, LogLevelMessageResources.SendConfigSection, LogLevelMessageResources.MessageStateCategory + LogLevelMessageResources.UpdateDescription)]
