...
namespace SmsHub.Api.Controllers.V1.Sending.Commands.Update
{
    ...
    public class MessageHolderUpdateController : BaseController
    {
        ...
        private readonly IMessageBatchGetSingleHandler _messageBatchGetSingleHandler;
        public MessageHolderUpdateController(
            IUnitOfWork uow,
            IMessageHolderUpdateHandler updateCommandHandler,
            IMessageBatchGetSingleHandler messageBatchGetSingleHandler)
        {
            _uow = uow;
            ...
            _messageBatchGetSingleHandler = messageBatchGetSingleHandler;
            _messageBatchGetSingleHandler.NotNull(nameof(messageBatchGetSingleHandler));
        }
        ...
        {
            var messagebatch = await _messageBatchGetSingleHandler.Handle(updateDto.MessageBatchId);
