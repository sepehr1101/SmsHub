...
namespace SmsHub.Api.Controllers.V1.Contact.Commands.Update
{
    ...
    public class ContactCategoryUpdateController : BaseController
    {
        ...
        [InformativeLogFilter(LogLevelEnum.InternalOperation, LogLevelMessageResources.SendConfigSection, LogLevelMessageResources.UpdateContactCategoryDescription)]
