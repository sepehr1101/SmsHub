...
namespace SmsHub.Api.Controllers.V1.Consumer.Commands.Update
{
    ...
    [ApiController]
    public class ConsumerSafeIpUpdateController : BaseController
    {
        private readonly IUnitOfWork _uow;
        private readonly IConsumerSafaIpUpdateHandler _updateCommandHandler;
        public ConsumerSafeIpUpdateController(
            IUnitOfWork uow,
            IConsumerSafaIpUpdateHandler updateCommandHandler)
        {
            _uow = uow;
        ...
        [HttpPost]
        [Route(nameof(Update))]
        [ProducesResponseType(typeof(ApiResponseEnvelope<UpdateConsumerSafeIpDto>), StatusCodes.Status200OK)]
