...
namespace SmsHub.Api.Controllers.V1.Logging.Commands.Create
{
    ...
    public class LogLevelCreateController : BaseController
    {
        ...
        public LogLevelCreateController(
            IUnitOfWork uow, 
            ILogLevelCreateHandler createCommandHandler)
        {
            _uow = uow;
        ...
        [HttpPost]
        [Route(nameof(Create))]
        [ProducesResponseType(typeof(ApiResponseEnvelope<CreateLogLevelDto>), StatusCodes.Status200OK)]
