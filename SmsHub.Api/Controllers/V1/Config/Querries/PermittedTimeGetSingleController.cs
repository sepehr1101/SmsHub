...
namespace SmsHub.Api.Controllers.V1.Config.Querries
{
    ...
    public class PermittedTimeGetSingleController : BaseController
    {
        ...
        [InformativeLogFilter(LogLevelEnum.InternalOperation, LogLevelMessageResources.SendConfigSection, LogLevelMessageResources.GetOnePermittedTimeDescription)]
