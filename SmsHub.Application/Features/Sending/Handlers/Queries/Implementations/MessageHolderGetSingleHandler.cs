...
namespace SmsHub.Application.Features.Sending.Handlers.Queries.Implementations
{
    public class MessageHolderGetSingleHandler: IMessageHolderGetSingleHandler
    {
        ...
        public MessageHolderGetSingleHandler(
            IMapper mapper, 
        ...
        public async Task<GetMessageHolderDto> Handle(GuidId Id)
        {
            var messageHolder = await _messagesHolderQueryService.Get(Id.Id);
