...
namespace SmsHub.Application.Features.Sending.Handlers.Commands.Update.Implementations
{
    public class MessageHolderUpdateHandler : IMessageHolderUpdateHandler
    {
        ...
        public MessageHolderUpdateHandler(
            IMapper mapper,
            IMessagesHolderQueryService messagesHolderQueryService,
            IValidator<UpdateMessageHolderDto> validator)
        {
            _mapper = mapper;
        ...
        {
            await CheckValidator(updateMessageHolderDto, cancellationToken);
        ...
        private async Task CheckValidator(UpdateMessageHolderDto updateMessageHolderDto, CancellationToken cancellationToken)
        {
