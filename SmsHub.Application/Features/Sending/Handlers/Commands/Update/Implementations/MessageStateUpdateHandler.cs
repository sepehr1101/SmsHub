...
namespace SmsHub.Application.Features.Sending.Handlers.Commands.Update.Implementations
{
    public class MessageStateUpdateHandler : IMessageStateUpdateHandler
    {
        ...
        public MessageStateUpdateHandler(
            IMapper mapper, 
            IMessageStateQueryService messageStateQueryService, 
            IValidator<UpdateMessageStateDto> validator)
        {
            _mapper = mapper;
        ...
        {
            await CheckValidator(updateMessageStateDto, cancellationToken);
        ...
        private async Task CheckValidator(UpdateMessageStateDto updateMessageStateDto, CancellationToken cancellationToken)
        {
