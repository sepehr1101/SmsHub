...
namespace SmsHub.Application.Features.Contact.Handlers.Queries.Implementations
{
    public class ContactNumberCategoryGetSingleHandler: IContactNumberCategoryGetSingleHandler
    {
        ...
        public ContactNumberCategoryGetSingleHandler(IMapper mapper, IContactNumberCategoryQueryService contactNumberCategoryQueryService)
        {
            _mapper = mapper;
        ...
        public async Task<GetContactNumberCategoryDto> Handle(int Id)
        {
            var contactNumberCategory = await _contactNumberCategoryQueryService.Get(Id);
