...
{
    public  class UpdateContactNumberCategoryHandler: IUpdateContactNumberCategoryHandler
    {
        private readonly IMapper _mapper;
        private readonly IContactNumberCategoryQueryService _contactNumberCategoryQueryService;
        public UpdateContactNumberCategoryHandler(IMapper mapper, IContactNumberCategoryQueryService contactNumberCategoryQueryService)
        {
            _mapper = mapper;
