...
{
    public class UpdateConfigTypeGroupeHandler: IUpdateConfigTypeGroupeHandler
    {
        private readonly IMapper _mapper;
        private readonly IConfigTypeGroupQueryService _configTypeGroupQueryService;
        public UpdateConfigTypeGroupeHandler(IMapper mapper, IConfigTypeGroupQueryService configTypeGroupQueryService)
        {
            _mapper = mapper;
